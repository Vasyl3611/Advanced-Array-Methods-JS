...
const f1 = () => {
    ...
    const result = a1.indexOf(parseInt(i1.value));
...
const f2 = () => {
	...
	let result = a2.indexOf(parseInt(i2.value))
	result = result > -1 ? true+ ' індекс:' + a2.indexOf(parseInt(i2.value)) : false
	out.textContent = result;
}
...
const f3 = () => {
	...
	let result = a3.indexOf(parseInt(i3.value))
...
const f5 = () => {
	...
	let i5 = document.querySelector('.i-5-1');
	let i5_2 = document.querySelector('.i-5-2');
	let result = a5.indexOf(parseInt(i5.value), parseInt(i5_2.value))
	out.textContent = result;
}
...
const f6 = () => {
	...
	let result = a6.indexOf(parseInt(i6.value))
	out.textContent = result;
}
